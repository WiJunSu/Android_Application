 ...
 * {@link Horror.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link Horror#newInstance} factory method to
...
public class Horror extends Fragment {
    ...
    public static Horror newInstance(String param1, String param2) {
        Horror fragment = new Horror();
    ...
    class BackgroundTask extends AsyncTask<Void, Void, String> {
        ...
        protected void onPreExecute() {
            try {
                target = "http://bbagazy.cafe24.com/MovieList.php?movieKind=" + URLEncoder.encode("공포", "UTF-8");
            } catch (Exception e) {
                e.printStackTrace();
            }
        }
