 ...
 * {@link Romance.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link Romance#newInstance} factory method to
...
public class Romance extends Fragment {
    ...
    public static Romance newInstance(String param1, String param2) {
        Romance fragment = new Romance();
    ...
    class BackgroundTask extends AsyncTask<Void, Void, String> {
        ...
        protected void onPreExecute() {
            try {
                target = "http://bbagazy.cafe24.com/MovieList.php?movieKind=" + URLEncoder.encode("로맨스", "UTF-8");
            } catch (Exception e) {
                e.printStackTrace();
            }
        }
